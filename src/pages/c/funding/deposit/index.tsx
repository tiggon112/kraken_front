            ...
            <CustomCard className="mt-4 flex flex-col gap-8 p-6 px-8">
              ...
              <div className="flex flex-col gap-8 text-stone-600">
                <Menu as="div" className="relative inline-block text-left">
                  ...
                  >
                    <Menu.Items className="absolute right-0 mt-4 w-full origin-top-right divide-y divide-gray-100 rounded-md bg-white p-2 shadow-lg ring-1 ring-black/5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                ...
                <div className="border-1 rounded-md border border-rose-950 bg-yellow-100 px-2 text-sm">
